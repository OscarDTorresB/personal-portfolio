...
- **🛡️ Secure by Default**: The Gemini API key stays server-side, requests are rate limited per IP, and transient upstream failures are retried with exponential backoff.
