...
export const ImpactStats = () => (
    <section
        className="grid grid-cols-2 auto-rows-fr md:grid-cols-4 gap-4 md:gap-6 mb-32"
    >
        {DATA.impact.map((s, i) => (
            <FadeIn
                key={i}
                delay={i * 0.1}
            >
                <Card className="h-full p-6 md:p-8 rounded-3xl group hover:border-sky-500/40 transition-all">
